    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-shrink-0 border-b bg-white px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">Guide de voyage</h1>
            <p className="text-muted-foreground mt-1">
              Fiches descriptives multi-langues : attractions, destinations, activités, hébergements, restaurants
            </p>
          </div>
      ...
      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Créez une nouvelle fiche descriptive pour une attraction, destination, activité ou hébergement.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4 space-y-4">
            ...
            >
              ...
              <div className="text-left">
                <p className="font-medium text-muted-foreground">Créer manuellement</p>
                <p className="text-sm text-muted-foreground">
                  Bientôt disponible
                </p>
              </div>
